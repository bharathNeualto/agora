...
$(() => {
  ...
  console.log("bharath from url "+JSON.stringify(options));
  if (options.appid && options.channel  && options.token) {
    prejoin();
  }
    
    console.log("in join-form==>"+JSON.stringify(options));
    //await join();
...
async function prejoin () {
  ...
  try {
    ...
    console.log("in prejoin-form==>"+JSON.stringify(options));
    await join();
    if(options.token) {
...
async function join() {
  ...
  console.log("in join function "+JSON.stringify(options));
  ...
  // console.log("done join function");
}
